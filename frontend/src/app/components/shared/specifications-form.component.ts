...
/**
 * Sections de spécifications dynamiques partagées — même UI et mêmes règles
 * pour Nouveau Changement et Nouveau Ticket. La visibilité des sections et des
 * champs dépend du couple catégorie/sous-catégorie (cf. models/changement.model).
 */
@Component({
