...
|---|---|---|---|
| UC-OPERATOR-001 | See monitoring in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-OPERATOR-002 | Order monitoring | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-OPERATOR-003 | Open the monitoring module | /apps/monitoring | NOT_IMPLEMENTED |
| UC-OPERATOR-004 | Assign operator to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-OPERATOR-005 | Use a monitoring license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-OPERATOR-001 — See monitoring in the catalog
...
## UC-OPERATOR-002 — Order monitoring
...
## UC-OPERATOR-003 — Open the monitoring module
...
## UC-OPERATOR-004 — Assign operator to a user
...
## UC-OPERATOR-005 — Use a monitoring license
