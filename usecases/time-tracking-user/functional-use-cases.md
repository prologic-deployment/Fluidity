...
|---|---|---|---|
| UC-TIMETRACKINGUSER-001 | See time_tracking in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-TIMETRACKINGUSER-002 | Order time_tracking | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-TIMETRACKINGUSER-003 | Open the time_tracking module | /apps/time_tracking | NOT_IMPLEMENTED |
| UC-TIMETRACKINGUSER-004 | Assign user to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-TIMETRACKINGUSER-005 | Use a time_tracking license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-TIMETRACKINGUSER-001 — See time_tracking in the catalog
...
- Product time_tracking (coming_soon)
...
## UC-TIMETRACKINGUSER-002 — Order time_tracking
...
## UC-TIMETRACKINGUSER-003 — Open the time_tracking module
...
## UC-TIMETRACKINGUSER-004 — Assign user to a user
...
## UC-TIMETRACKINGUSER-005 — Use a time_tracking license
