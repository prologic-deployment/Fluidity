...
|---|---|---|---|
| UC-SECURITYADMIN-001 | See security_center in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-SECURITYADMIN-002 | Order security_center | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-SECURITYADMIN-003 | Open the security_center module | /apps/security_center | NOT_IMPLEMENTED |
| UC-SECURITYADMIN-004 | Assign security_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-SECURITYADMIN-005 | Use a security_center license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-SECURITYADMIN-001 — See security_center in the catalog
...
## UC-SECURITYADMIN-002 — Order security_center
...
## UC-SECURITYADMIN-003 — Open the security_center module
...
## UC-SECURITYADMIN-004 — Assign security_admin to a user
...
## UC-SECURITYADMIN-005 — Use a security_center license
