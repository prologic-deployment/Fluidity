...
- Assign support_n2 to a user — IMPLEMENTED
- Remove support_n2 from a user — IMPLEMENTED
- Exercise support_n2 permissions — NOT_IMPLEMENTED
- Access ServiceDesk holding support_n2 — PARTIAL
