...
|---|---|---|---|
| UC-SUPPORTN2-001 | Assign support_n2 to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-SUPPORTN2-002 | Remove support_n2 from a user | DELETE /api/platform/roles/assignments/:id | IMPLEMENTED |
| UC-SUPPORTN2-003 | Exercise support_n2 permissions | (any servicedesk API) | NOT_IMPLEMENTED |
| UC-SUPPORTN2-004 | Access ServiceDesk holding support_n2 | GET /api/tickets etc. | PARTIAL |

## UC-SUPPORTN2-001 — Assign support_n2 to a user
...
- RoleAssignment(support_n2) present (except for the assignment UC itself)
...
## UC-SUPPORTN2-002 — Remove support_n2 from a user
...
## UC-SUPPORTN2-003 — Exercise support_n2 permissions
...
## UC-SUPPORTN2-004 — Access ServiceDesk holding support_n2
