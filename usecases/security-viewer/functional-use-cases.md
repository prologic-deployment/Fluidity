...
|---|---|---|---|
| UC-SECURITYVIEWER-001 | See security_center in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-SECURITYVIEWER-002 | Order security_center | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-SECURITYVIEWER-003 | Open the security_center module | /apps/security_center | NOT_IMPLEMENTED |
| UC-SECURITYVIEWER-004 | Assign security_viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-SECURITYVIEWER-005 | Use a security_center license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-SECURITYVIEWER-001 — See security_center in the catalog
...
## UC-SECURITYVIEWER-002 — Order security_center
...
## UC-SECURITYVIEWER-003 — Open the security_center module
...
## UC-SECURITYVIEWER-004 — Assign security_viewer to a user
...
## UC-SECURITYVIEWER-005 — Use a security_center license
