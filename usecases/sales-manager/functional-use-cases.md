...
|---|---|---|---|
| UC-SALESMANAGER-001 | See crm in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-SALESMANAGER-002 | Order crm | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-SALESMANAGER-003 | Open the crm module | /apps/crm | NOT_IMPLEMENTED |
| UC-SALESMANAGER-004 | Assign sales_manager to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-SALESMANAGER-005 | Use a crm license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-SALESMANAGER-001 — See crm in the catalog
...
## UC-SALESMANAGER-003 — Open the crm module
...
## UC-SALESMANAGER-004 — Assign sales_manager to a user
...
## UC-SALESMANAGER-005 — Use a crm license
