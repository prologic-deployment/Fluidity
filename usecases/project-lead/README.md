...
Scope: product role of **project_management** (project rank 3).
...
- **Tasks**: List / board / get / backlog tasks; Create task (+ optional assignee); Full task update (PUT); Change task status (transition/move); Edit task checklist; Watch / unwatch task
