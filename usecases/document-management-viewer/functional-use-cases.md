...
|---|---|---|---|
| UC-DOCUMENTMANAGEMENTVIEWER-001 | See document_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-DOCUMENTMANAGEMENTVIEWER-002 | Order document_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-DOCUMENTMANAGEMENTVIEWER-003 | Open the document_management module | /apps/document_management | NOT_IMPLEMENTED |
| UC-DOCUMENTMANAGEMENTVIEWER-004 | Assign viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-DOCUMENTMANAGEMENTVIEWER-005 | Use a document_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-DOCUMENTMANAGEMENTVIEWER-001 — See document_management in the catalog
...
- Product document_management (coming_soon)
...
## UC-DOCUMENTMANAGEMENTVIEWER-002 — Order document_management
...
## UC-DOCUMENTMANAGEMENTVIEWER-003 — Open the document_management module
...
## UC-DOCUMENTMANAGEMENTVIEWER-004 — Assign viewer to a user
...
## UC-DOCUMENTMANAGEMENTVIEWER-005 — Use a document_management license
