...
|---|---|---|---|
| UC-HRMANAGER-001 | See hr_center in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-HRMANAGER-002 | Order hr_center | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-HRMANAGER-003 | Open the hr_center module | /apps/hr_center | NOT_IMPLEMENTED |
| UC-HRMANAGER-004 | Assign hr_manager to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-HRMANAGER-005 | Use a hr_center license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-HRMANAGER-001 — See hr_center in the catalog
...
## UC-HRMANAGER-002 — Order hr_center
...
## UC-HRMANAGER-003 — Open the hr_center module
...
## UC-HRMANAGER-004 — Assign hr_manager to a user
...
## UC-HRMANAGER-005 — Use a hr_center license
