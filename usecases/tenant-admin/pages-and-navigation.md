...
| Sidebar | — | Projects (if entitled) + Workspace (tickets/demandes/changements) + Subscriptions (/abonnements*) + Users + Contrats/Clients (incl. “new” links) |
