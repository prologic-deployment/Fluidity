...
|---|---|---|---|
| UC-KNOWLEDGEADMIN-001 | See knowledge_center in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-KNOWLEDGEADMIN-002 | Order knowledge_center | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-KNOWLEDGEADMIN-003 | Open the knowledge_center module | /apps/knowledge_center | NOT_IMPLEMENTED |
| UC-KNOWLEDGEADMIN-004 | Assign knowledge_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-KNOWLEDGEADMIN-005 | Use a knowledge_center license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-KNOWLEDGEADMIN-001 — See knowledge_center in the catalog
...
## UC-KNOWLEDGEADMIN-002 — Order knowledge_center
...
## UC-KNOWLEDGEADMIN-003 — Open the knowledge_center module
...
## UC-KNOWLEDGEADMIN-004 — Assign knowledge_admin to a user
...
## UC-KNOWLEDGEADMIN-005 — Use a knowledge_center license
