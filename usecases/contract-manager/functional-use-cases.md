...
|---|---|---|---|
| UC-CONTRACTMANAGER-001 | See contract_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-CONTRACTMANAGER-002 | Order contract_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-CONTRACTMANAGER-003 | Open the contract_management module | /apps/contract_management | NOT_IMPLEMENTED |
| UC-CONTRACTMANAGER-004 | Assign contract_manager to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-CONTRACTMANAGER-005 | Use a contract_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-CONTRACTMANAGER-001 — See contract_management in the catalog
...
- Product contract_management (coming_soon)
...
## UC-CONTRACTMANAGER-002 — Order contract_management
...
## UC-CONTRACTMANAGER-003 — Open the contract_management module
...
## UC-CONTRACTMANAGER-004 — Assign contract_manager to a user
...
## UC-CONTRACTMANAGER-005 — Use a contract_management license
