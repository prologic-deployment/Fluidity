...
|---|---|---|---|
| UC-BACKUPMANAGEMENTVIEWER-001 | See backup_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-BACKUPMANAGEMENTVIEWER-002 | Order backup_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-BACKUPMANAGEMENTVIEWER-003 | Open the backup_management module | /apps/backup_management | NOT_IMPLEMENTED |
| UC-BACKUPMANAGEMENTVIEWER-004 | Assign viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-BACKUPMANAGEMENTVIEWER-005 | Use a backup_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-BACKUPMANAGEMENTVIEWER-001 — See backup_management in the catalog
...
## UC-BACKUPMANAGEMENTVIEWER-002 — Order backup_management
...
## UC-BACKUPMANAGEMENTVIEWER-003 — Open the backup_management module
...
## UC-BACKUPMANAGEMENTVIEWER-004 — Assign viewer to a user
...
## UC-BACKUPMANAGEMENTVIEWER-005 — Use a backup_management license
