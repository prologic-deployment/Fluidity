...
|---|---|---|---|
| UC-FLEETADMIN-001 | See fleet_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-FLEETADMIN-002 | Order fleet_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-FLEETADMIN-003 | Open the fleet_management module | /apps/fleet_management | NOT_IMPLEMENTED |
| UC-FLEETADMIN-004 | Assign fleet_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-FLEETADMIN-005 | Use a fleet_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-FLEETADMIN-001 — See fleet_management in the catalog
...
## UC-FLEETADMIN-002 — Order fleet_management
...
## UC-FLEETADMIN-003 — Open the fleet_management module
...
## UC-FLEETADMIN-004 — Assign fleet_admin to a user
...
## UC-FLEETADMIN-005 — Use a fleet_management license
