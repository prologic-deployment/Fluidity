...
|---|---|---|---|
| UC-SALESVIEWER-001 | See crm in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-SALESVIEWER-002 | Order crm | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-SALESVIEWER-003 | Open the crm module | /apps/crm | NOT_IMPLEMENTED |
| UC-SALESVIEWER-004 | Assign sales_viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-SALESVIEWER-005 | Use a crm license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-SALESVIEWER-001 — See crm in the catalog
...
## UC-SALESVIEWER-003 — Open the crm module
...
## UC-SALESVIEWER-004 — Assign sales_viewer to a user
...
## UC-SALESVIEWER-005 — Use a crm license
