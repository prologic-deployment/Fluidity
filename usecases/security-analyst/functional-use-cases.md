...
|---|---|---|---|
| UC-SECURITYANALYST-001 | See security_center in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-SECURITYANALYST-002 | Order security_center | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-SECURITYANALYST-003 | Open the security_center module | /apps/security_center | NOT_IMPLEMENTED |
| UC-SECURITYANALYST-004 | Assign security_analyst to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-SECURITYANALYST-005 | Use a security_center license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-SECURITYANALYST-001 — See security_center in the catalog
...
## UC-SECURITYANALYST-002 — Order security_center
...
## UC-SECURITYANALYST-003 — Open the security_center module
...
## UC-SECURITYANALYST-004 — Assign security_analyst to a user
...
## UC-SECURITYANALYST-005 — Use a security_center license
