...
|---|---|---|---|
| UC-CRMADMIN-001 | See crm in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-CRMADMIN-002 | Order crm | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-CRMADMIN-003 | Open the crm module | /apps/crm | NOT_IMPLEMENTED |
| UC-CRMADMIN-004 | Assign crm_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-CRMADMIN-005 | Use a crm license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-CRMADMIN-001 — See crm in the catalog
...
## UC-CRMADMIN-003 — Open the crm module
...
## UC-CRMADMIN-004 — Assign crm_admin to a user
...
## UC-CRMADMIN-005 — Use a crm license
