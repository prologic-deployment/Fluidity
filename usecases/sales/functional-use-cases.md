...
|---|---|---|---|
| UC-SALES-001 | See crm in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-SALES-002 | Order crm | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-SALES-003 | Open the crm module | /apps/crm | NOT_IMPLEMENTED |
| UC-SALES-004 | Assign sales to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-SALES-005 | Use a crm license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-SALES-001 — See crm in the catalog
...
## UC-SALES-003 — Open the crm module
...
## UC-SALES-004 — Assign sales to a user
...
## UC-SALES-005 — Use a crm license
