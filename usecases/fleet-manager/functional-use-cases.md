...
|---|---|---|---|
| UC-FLEETMANAGER-001 | See fleet_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-FLEETMANAGER-002 | Order fleet_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-FLEETMANAGER-003 | Open the fleet_management module | /apps/fleet_management | NOT_IMPLEMENTED |
| UC-FLEETMANAGER-004 | Assign fleet_manager to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-FLEETMANAGER-005 | Use a fleet_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-FLEETMANAGER-001 — See fleet_management in the catalog
...
## UC-FLEETMANAGER-002 — Order fleet_management
...
## UC-FLEETMANAGER-003 — Open the fleet_management module
...
## UC-FLEETMANAGER-004 — Assign fleet_manager to a user
...
## UC-FLEETMANAGER-005 — Use a fleet_management license
