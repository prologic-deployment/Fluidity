...
|---|---|---|---|
| UC-FLEETOPERATOR-001 | See fleet_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-FLEETOPERATOR-002 | Order fleet_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-FLEETOPERATOR-003 | Open the fleet_management module | /apps/fleet_management | NOT_IMPLEMENTED |
| UC-FLEETOPERATOR-004 | Assign fleet_operator to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-FLEETOPERATOR-005 | Use a fleet_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-FLEETOPERATOR-001 — See fleet_management in the catalog
...
- Product fleet_management (coming_soon)
...
## UC-FLEETOPERATOR-002 — Order fleet_management
...
## UC-FLEETOPERATOR-003 — Open the fleet_management module
...
## UC-FLEETOPERATOR-004 — Assign fleet_operator to a user
...
## UC-FLEETOPERATOR-005 — Use a fleet_management license
