...
|---|---|---|---|
| UC-EMPLOYEE-001 | See hr_center in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-EMPLOYEE-002 | Order hr_center | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-EMPLOYEE-003 | Open the hr_center module | /apps/hr_center | NOT_IMPLEMENTED |
| UC-EMPLOYEE-004 | Assign employee to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-EMPLOYEE-005 | Use a hr_center license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-EMPLOYEE-001 — See hr_center in the catalog
...
## UC-EMPLOYEE-002 — Order hr_center
...
## UC-EMPLOYEE-003 — Open the hr_center module
...
## UC-EMPLOYEE-004 — Assign employee to a user
...
## UC-EMPLOYEE-005 — Use a hr_center license
