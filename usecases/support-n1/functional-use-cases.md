...
|---|---|---|---|
| UC-SUPPORTN1-001 | Assign support_n1 to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-SUPPORTN1-002 | Remove support_n1 from a user | DELETE /api/platform/roles/assignments/:id | IMPLEMENTED |
| UC-SUPPORTN1-003 | Exercise support_n1 permissions | (any servicedesk API) | NOT_IMPLEMENTED |
| UC-SUPPORTN1-004 | Access ServiceDesk holding support_n1 | GET /api/tickets etc. | PARTIAL |

## UC-SUPPORTN1-001 — Assign support_n1 to a user
...
- RoleAssignment(support_n1) present (except for the assignment UC itself)
...
## UC-SUPPORTN1-002 — Remove support_n1 from a user
...
## UC-SUPPORTN1-003 — Exercise support_n1 permissions
...
## UC-SUPPORTN1-004 — Access ServiceDesk holding support_n1
