...
|---|---|---|---|
| UC-DOCUMENTADMIN-001 | See document_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-DOCUMENTADMIN-002 | Order document_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-DOCUMENTADMIN-003 | Open the document_management module | /apps/document_management | NOT_IMPLEMENTED |
| UC-DOCUMENTADMIN-004 | Assign document_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-DOCUMENTADMIN-005 | Use a document_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-DOCUMENTADMIN-001 — See document_management in the catalog
...
## UC-DOCUMENTADMIN-002 — Order document_management
...
## UC-DOCUMENTADMIN-003 — Open the document_management module
...
## UC-DOCUMENTADMIN-004 — Assign document_admin to a user
...
## UC-DOCUMENTADMIN-005 — Use a document_management license
