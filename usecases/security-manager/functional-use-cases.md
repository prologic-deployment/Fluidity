...
|---|---|---|---|
| UC-SECURITYMANAGER-001 | See security_center in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-SECURITYMANAGER-002 | Order security_center | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-SECURITYMANAGER-003 | Open the security_center module | /apps/security_center | NOT_IMPLEMENTED |
| UC-SECURITYMANAGER-004 | Assign security_manager to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-SECURITYMANAGER-005 | Use a security_center license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-SECURITYMANAGER-001 — See security_center in the catalog
...
- Product security_center (coming_soon)
...
## UC-SECURITYMANAGER-002 — Order security_center
...
## UC-SECURITYMANAGER-003 — Open the security_center module
...
## UC-SECURITYMANAGER-004 — Assign security_manager to a user
...
## UC-SECURITYMANAGER-005 — Use a security_center license
