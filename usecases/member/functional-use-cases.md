...
|---|---|---|---|
| UC-MEMBER-001 | See collaboration in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-MEMBER-002 | Order collaboration | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-MEMBER-003 | Open the collaboration module | /apps/collaboration | NOT_IMPLEMENTED |
| UC-MEMBER-004 | Assign member to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-MEMBER-005 | Use a collaboration license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-MEMBER-001 — See collaboration in the catalog
...
## UC-MEMBER-002 — Order collaboration
...
## UC-MEMBER-003 — Open the collaboration module
...
## UC-MEMBER-004 — Assign member to a user
...
## UC-MEMBER-005 — Use a collaboration license
