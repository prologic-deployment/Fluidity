...
|---|---|---|---|
| UC-CONTRIBUTOR-001 | See knowledge_center in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-CONTRIBUTOR-002 | Order knowledge_center | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-CONTRIBUTOR-003 | Open the knowledge_center module | /apps/knowledge_center | NOT_IMPLEMENTED |
| UC-CONTRIBUTOR-004 | Assign contributor to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-CONTRIBUTOR-005 | Use a knowledge_center license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-CONTRIBUTOR-001 — See knowledge_center in the catalog
...
## UC-CONTRIBUTOR-002 — Order knowledge_center
...
## UC-CONTRIBUTOR-003 — Open the knowledge_center module
...
## UC-CONTRIBUTOR-004 — Assign contributor to a user
...
## UC-CONTRIBUTOR-005 — Use a knowledge_center license
