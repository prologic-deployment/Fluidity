...
|---|---|---|---|
| UC-BUSINESSINTELLIGENCEVIEWER-001 | See business_intelligence in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-BUSINESSINTELLIGENCEVIEWER-002 | Order business_intelligence | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-BUSINESSINTELLIGENCEVIEWER-003 | Open the business_intelligence module | /apps/business_intelligence | NOT_IMPLEMENTED |
| UC-BUSINESSINTELLIGENCEVIEWER-004 | Assign viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-BUSINESSINTELLIGENCEVIEWER-005 | Use a business_intelligence license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-BUSINESSINTELLIGENCEVIEWER-001 — See business_intelligence in the catalog
...
## UC-BUSINESSINTELLIGENCEVIEWER-002 — Order business_intelligence
...
## UC-BUSINESSINTELLIGENCEVIEWER-003 — Open the business_intelligence module
...
## UC-BUSINESSINTELLIGENCEVIEWER-004 — Assign viewer to a user
...
## UC-BUSINESSINTELLIGENCEVIEWER-005 — Use a business_intelligence license
