...
|---|---|---|---|
| UC-HRSPECIALIST-001 | See hr_center in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-HRSPECIALIST-002 | Order hr_center | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-HRSPECIALIST-003 | Open the hr_center module | /apps/hr_center | NOT_IMPLEMENTED |
| UC-HRSPECIALIST-004 | Assign hr_specialist to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-HRSPECIALIST-005 | Use a hr_center license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-HRSPECIALIST-001 — See hr_center in the catalog
...
## UC-HRSPECIALIST-002 — Order hr_center
...
## UC-HRSPECIALIST-003 — Open the hr_center module
...
## UC-HRSPECIALIST-004 — Assign hr_specialist to a user
...
## UC-HRSPECIALIST-005 — Use a hr_center license
