# Role: monitoring_manager

| UC | Action | API | Status |
|---|---|---|---|
| UC-MONITORINGMANAGER-001 | See monitoring in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-MONITORINGMANAGER-002 | Order monitoring | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-MONITORINGMANAGER-003 | Open the monitoring module | /apps/monitoring | NOT_IMPLEMENTED |
| UC-MONITORINGMANAGER-004 | Assign monitoring_manager to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-MONITORINGMANAGER-005 | Use a monitoring license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-MONITORINGMANAGER-001 — See monitoring in the catalog
...
- Product monitoring (coming_soon)
...
## UC-MONITORINGMANAGER-002 — Order monitoring
...
## UC-MONITORINGMANAGER-003 — Open the monitoring module
...
## UC-MONITORINGMANAGER-004 — Assign monitoring_manager to a user
...
## UC-MONITORINGMANAGER-005 — Use a monitoring license
