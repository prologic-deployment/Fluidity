...
|---|---|---|---|
| UC-COLLABORATIONVIEWER-001 | See collaboration in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-COLLABORATIONVIEWER-002 | Order collaboration | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-COLLABORATIONVIEWER-003 | Open the collaboration module | /apps/collaboration | NOT_IMPLEMENTED |
| UC-COLLABORATIONVIEWER-004 | Assign viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-COLLABORATIONVIEWER-005 | Use a collaboration license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-COLLABORATIONVIEWER-001 — See collaboration in the catalog
...
- Product collaboration (coming_soon)
...
## UC-COLLABORATIONVIEWER-002 — Order collaboration
...
## UC-COLLABORATIONVIEWER-003 — Open the collaboration module
...
## UC-COLLABORATIONVIEWER-004 — Assign viewer to a user
...
## UC-COLLABORATIONVIEWER-005 — Use a collaboration license
