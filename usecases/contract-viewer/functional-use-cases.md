...
|---|---|---|---|
| UC-CONTRACTVIEWER-001 | See contract_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-CONTRACTVIEWER-002 | Order contract_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-CONTRACTVIEWER-003 | Open the contract_management module | /apps/contract_management | NOT_IMPLEMENTED |
| UC-CONTRACTVIEWER-004 | Assign contract_viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-CONTRACTVIEWER-005 | Use a contract_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-CONTRACTVIEWER-001 — See contract_management in the catalog
...
## UC-CONTRACTVIEWER-002 — Order contract_management
...
## UC-CONTRACTVIEWER-003 — Open the contract_management module
...
## UC-CONTRACTVIEWER-004 — Assign contract_viewer to a user
...
## UC-CONTRACTVIEWER-005 — Use a contract_management license
