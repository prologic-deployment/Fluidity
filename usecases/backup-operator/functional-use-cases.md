...
|---|---|---|---|
| UC-BACKUPOPERATOR-001 | See backup_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-BACKUPOPERATOR-002 | Order backup_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-BACKUPOPERATOR-003 | Open the backup_management module | /apps/backup_management | NOT_IMPLEMENTED |
| UC-BACKUPOPERATOR-004 | Assign backup_operator to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-BACKUPOPERATOR-005 | Use a backup_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-BACKUPOPERATOR-001 — See backup_management in the catalog
...
## UC-BACKUPOPERATOR-002 — Order backup_management
...
## UC-BACKUPOPERATOR-003 — Open the backup_management module
...
## UC-BACKUPOPERATOR-004 — Assign backup_operator to a user
...
## UC-BACKUPOPERATOR-005 — Use a backup_management license
