...
|---|---|---|---|
| UC-CONTRACTADMIN-001 | See contract_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-CONTRACTADMIN-002 | Order contract_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-CONTRACTADMIN-003 | Open the contract_management module | /apps/contract_management | NOT_IMPLEMENTED |
| UC-CONTRACTADMIN-004 | Assign contract_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-CONTRACTADMIN-005 | Use a contract_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-CONTRACTADMIN-001 — See contract_management in the catalog
...
## UC-CONTRACTADMIN-002 — Order contract_management
...
## UC-CONTRACTADMIN-003 — Open the contract_management module
...
## UC-CONTRACTADMIN-004 — Assign contract_admin to a user
...
## UC-CONTRACTADMIN-005 — Use a contract_management license
