...
Rank 1. 27 allowed capabilities, 20 denied.

| UC | Action | API | Verdict | Status |
|---|---|---|---|---|
| UC-PROJECTMEMBER-001 | List projects | GET /api/projects | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-002 | View global dashboard | GET /api/projects/global | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-003 | View personal dashboard (my tasks) | GET /api/projects/me | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-004 | Cross-project search | GET /api/projects/search | YES (permission + guard only) | BACKEND_ONLY |
| UC-PROJECTMEMBER-005 | View project detail | GET /api/projects/:id | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-006 | View project dashboard tab | GET /api/projects/:id/dashboard | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-007 | View project calendar | GET /api/projects/:id/calendar | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-008 | Read workflow config | GET /api/projects/:id/workflow | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-009 | Read activity journal | GET /api/projects/:id/activity | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-010 | List project members (+license flags) | GET /api/projects/:id/members | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-011 | List / board / get / backlog tasks | GET /api/projects/:id/tasks* | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-012 | Full task update (PUT) | PUT /api/projects/:id/tasks/:taskId | PART (assignee-only (rank < 2)) | PARTIAL |
| UC-PROJECTMEMBER-013 | Change task status (transition/move) | PATCH /api/projects/:id/tasks/:taskId/{status,move} | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-014 | Edit task checklist | PATCH /api/projects/:id/tasks/:taskId/checklist | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-015 | Watch / unwatch task | POST /api/projects/:id/tasks/:taskId/watch | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-016 | List milestones | GET /api/projects/:id/milestones | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-017 | List sprints | GET /api/projects/:id/sprints | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-018 | Read comments | GET /api/projects/:id/comments | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-019 | Post comment (+ @mentions) | POST /api/projects/:id/comments | YES (rank 1 >= 1) | IMPLEMENTED |
| UC-PROJECTMEMBER-020 | Edit / delete comment | PUT/DELETE /api/projects/:id/comments/:commentId | PART (own comments only (rank < 5)) | PARTIAL |
| UC-PROJECTMEMBER-021 | List files | GET /api/projects/:id/files | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-022 | Upload file | POST /api/projects/:id/files | YES (rank 1 >= 1) | IMPLEMENTED |
| UC-PROJECTMEMBER-023 | List time entries | GET /api/projects/:id/time | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-024 | Edit / delete time entry | PATCH/DELETE /api/projects/:id/time/:entryId | PART (own entries only (rank < 3)) | PARTIAL |
| UC-PROJECTMEMBER-025 | List deliverables | GET /api/projects/:id/deliverables | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMEMBER-026 | Approve / reject deliverable | PATCH /api/projects/:id/deliverables/:id/status | PART (submit-only path (rank < 4 cannot approve/reject)) | PARTIAL |
| UC-PROJECTMEMBER-027 | List meetings/events | GET /api/projects/:id/events | YES (permission + guard only) | IMPLEMENTED |
...
| Log time | POST /api/projects/:id/time | rank 1 < 2 |
| Submit deliverable | POST /api/projects/:id/deliverables | rank 1 < 2 |
...
## UC-PROJECTMEMBER-001 — List projects
...
## UC-PROJECTMEMBER-002 — View global dashboard
...
## UC-PROJECTMEMBER-003 — View personal dashboard (my tasks)
...
## UC-PROJECTMEMBER-004 — Cross-project search
...
## UC-PROJECTMEMBER-005 — View project detail
...
## UC-PROJECTMEMBER-006 — View project dashboard tab
...
## UC-PROJECTMEMBER-007 — View project calendar
...
## UC-PROJECTMEMBER-008 — Read workflow config
...
## UC-PROJECTMEMBER-009 — Read activity journal
...
## UC-PROJECTMEMBER-010 — List project members (+license flags)
...
## UC-PROJECTMEMBER-011 — List / board / get / backlog tasks
...
## UC-PROJECTMEMBER-012 — Full task update (PUT)
...
4. `requireProductAccess('project_management', perm)` verifies subscription + license + product permission (403 PRODUCT_NOT_ACCESSIBLE / LICENSE_NOT_ASSIGNED / PERMISSION_DENIED)
5. `guardProjectRole(resolveProjectRole(...))` verifies project membership or tenant visibility (403 PROJECT_FORBIDDEN)
6. Controller rank rule: assignee-or-2 — this role: assignee-only (rank < 2)
...
### Permissions
- route perm project.task.update + rank rule assignee-or-2 — evaluated: assignee-only (rank < 2)
...
### Status
PARTIAL — partial scope: assignee-only (rank < 2)
...
## UC-PROJECTMEMBER-013 — Change task status (transition/move)
...
## UC-PROJECTMEMBER-014 — Edit task checklist
...
## UC-PROJECTMEMBER-015 — Watch / unwatch task
...
## UC-PROJECTMEMBER-016 — List milestones
...
## UC-PROJECTMEMBER-017 — List sprints
...
## UC-PROJECTMEMBER-018 — Read comments
...
## UC-PROJECTMEMBER-019 — Post comment (+ @mentions)
...
## UC-PROJECTMEMBER-020 — Edit / delete comment
...
## UC-PROJECTMEMBER-021 — List files
...
## UC-PROJECTMEMBER-022 — Upload file
...
## UC-PROJECTMEMBER-023 — List time entries
...
## UC-PROJECTMEMBER-024 — Edit / delete time entry
...
## UC-PROJECTMEMBER-025 — List deliverables
...
## UC-PROJECTMEMBER-026 — Approve / reject deliverable
...
## UC-PROJECTMEMBER-027 — List meetings/events
