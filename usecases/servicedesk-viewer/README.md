# Role: servicedesk_viewer (servicedesk)
...
- Assign servicedesk_viewer to a user — IMPLEMENTED
- Remove servicedesk_viewer from a user — IMPLEMENTED
- Exercise servicedesk_viewer permissions — NOT_IMPLEMENTED
- Access ServiceDesk holding servicedesk_viewer — PARTIAL
