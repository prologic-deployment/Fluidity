# Role: servicedesk_viewer

| UC | Action | API | Status |
|---|---|---|---|
| UC-SERVICEDESKVIEWER-001 | Assign servicedesk_viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-SERVICEDESKVIEWER-002 | Remove servicedesk_viewer from a user | DELETE /api/platform/roles/assignments/:id | IMPLEMENTED |
| UC-SERVICEDESKVIEWER-003 | Exercise servicedesk_viewer permissions | (any servicedesk API) | NOT_IMPLEMENTED |
| UC-SERVICEDESKVIEWER-004 | Access ServiceDesk holding servicedesk_viewer | GET /api/tickets etc. | PARTIAL |

## UC-SERVICEDESKVIEWER-001 — Assign servicedesk_viewer to a user
...
- RoleAssignment(servicedesk_viewer) present (except for the assignment UC itself)
...
## UC-SERVICEDESKVIEWER-002 — Remove servicedesk_viewer from a user
...
## UC-SERVICEDESKVIEWER-003 — Exercise servicedesk_viewer permissions
...
## UC-SERVICEDESKVIEWER-004 — Access ServiceDesk holding servicedesk_viewer
