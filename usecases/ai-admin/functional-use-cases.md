...
|---|---|---|---|
| UC-AIADMIN-001 | See ai_assistant in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-AIADMIN-002 | Order ai_assistant | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-AIADMIN-003 | Open the ai_assistant module | /apps/ai_assistant | NOT_IMPLEMENTED |
| UC-AIADMIN-004 | Assign ai_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-AIADMIN-005 | Use a ai_assistant license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-AIADMIN-001 — See ai_assistant in the catalog
...
## UC-AIADMIN-002 — Order ai_assistant
...
## UC-AIADMIN-003 — Open the ai_assistant module
...
## UC-AIADMIN-004 — Assign ai_admin to a user
...
## UC-AIADMIN-005 — Use a ai_assistant license
