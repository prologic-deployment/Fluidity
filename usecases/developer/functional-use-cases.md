...
|---|---|---|---|---|
| UC-DEVELOPER-001 | List projects | GET /api/projects | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-002 | View global dashboard | GET /api/projects/global | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-003 | View personal dashboard (my tasks) | GET /api/projects/me | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-004 | Cross-project search | GET /api/projects/search | YES (permission + guard only) | BACKEND_ONLY |
| UC-DEVELOPER-005 | View project detail | GET /api/projects/:id | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-006 | View project dashboard tab | GET /api/projects/:id/dashboard | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-007 | View project calendar | GET /api/projects/:id/calendar | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-008 | Read workflow config | GET /api/projects/:id/workflow | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-009 | Read activity journal | GET /api/projects/:id/activity | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-010 | List project members (+license flags) | GET /api/projects/:id/members | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-011 | List / board / get / backlog tasks | GET /api/projects/:id/tasks* | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-012 | Full task update (PUT) | PUT /api/projects/:id/tasks/:taskId | YES (rank 2 >= 2) | IMPLEMENTED |
| UC-DEVELOPER-013 | Change task status (transition/move) | PATCH /api/projects/:id/tasks/:taskId/{status,move} | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-014 | Edit task checklist | PATCH /api/projects/:id/tasks/:taskId/checklist | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-015 | Watch / unwatch task | POST /api/projects/:id/tasks/:taskId/watch | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-016 | List milestones | GET /api/projects/:id/milestones | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-017 | List sprints | GET /api/projects/:id/sprints | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-018 | Read comments | GET /api/projects/:id/comments | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-019 | Post comment (+ @mentions) | POST /api/projects/:id/comments | YES (rank 2 >= 1) | IMPLEMENTED |
| UC-DEVELOPER-020 | Edit / delete comment | PUT/DELETE /api/projects/:id/comments/:commentId | PART (own comments only (rank < 5)) | PARTIAL |
| UC-DEVELOPER-021 | List files | GET /api/projects/:id/files | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-022 | Upload file | POST /api/projects/:id/files | YES (rank 2 >= 1) | IMPLEMENTED |
| UC-DEVELOPER-023 | List time entries | GET /api/projects/:id/time | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-024 | Log time | POST /api/projects/:id/time | YES (rank 2 >= 2) | IMPLEMENTED |
| UC-DEVELOPER-025 | Edit / delete time entry | PATCH/DELETE /api/projects/:id/time/:entryId | PART (own entries only (rank < 3)) | PARTIAL |
| UC-DEVELOPER-026 | List deliverables | GET /api/projects/:id/deliverables | YES (permission + guard only) | IMPLEMENTED |
| UC-DEVELOPER-027 | Submit deliverable | POST /api/projects/:id/deliverables | YES (rank 2 >= 2) | IMPLEMENTED |
| UC-DEVELOPER-028 | Approve / reject deliverable | PATCH /api/projects/:id/deliverables/:id/status | PART (submit-only path (rank < 4 cannot approve/reject)) | PARTIAL |
| UC-DEVELOPER-029 | List meetings/events | GET /api/projects/:id/events | YES (permission + guard only) | IMPLEMENTED |
...
## UC-DEVELOPER-001 — List projects
...
## UC-DEVELOPER-002 — View global dashboard
...
## UC-DEVELOPER-003 — View personal dashboard (my tasks)
...
## UC-DEVELOPER-004 — Cross-project search
...
## UC-DEVELOPER-005 — View project detail
...
## UC-DEVELOPER-006 — View project dashboard tab
...
## UC-DEVELOPER-007 — View project calendar
...
## UC-DEVELOPER-008 — Read workflow config
...
## UC-DEVELOPER-009 — Read activity journal
...
## UC-DEVELOPER-010 — List project members (+license flags)
...
## UC-DEVELOPER-011 — List / board / get / backlog tasks
...
## UC-DEVELOPER-012 — Full task update (PUT)
...
## UC-DEVELOPER-013 — Change task status (transition/move)
...
## UC-DEVELOPER-014 — Edit task checklist
...
## UC-DEVELOPER-015 — Watch / unwatch task
...
## UC-DEVELOPER-016 — List milestones
...
## UC-DEVELOPER-018 — Read comments
...
## UC-DEVELOPER-019 — Post comment (+ @mentions)
...
## UC-DEVELOPER-020 — Edit / delete comment
...
## UC-DEVELOPER-023 — List time entries
...
## UC-DEVELOPER-025 — Edit / delete time entry
...
## UC-DEVELOPER-026 — List deliverables
...
## UC-DEVELOPER-027 — Submit deliverable
...
## UC-DEVELOPER-028 — Approve / reject deliverable
...
## UC-DEVELOPER-029 — List meetings/events
