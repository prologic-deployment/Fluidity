...
Rank 5. 44 allowed capabilities, 3 denied.

| UC | Action | API | Verdict | Status |
|---|---|---|---|---|
| UC-PROJECTMANAGER-001 | List projects | GET /api/projects | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-002 | View global dashboard | GET /api/projects/global | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-003 | View personal dashboard (my tasks) | GET /api/projects/me | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-004 | Cross-project search | GET /api/projects/search | YES (permission + guard only) | BACKEND_ONLY |
| UC-PROJECTMANAGER-005 | Create project | POST /api/projects | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-006 | View project detail | GET /api/projects/:id | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-007 | Update project settings | PUT /api/projects/:id | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-008 | Archive / unarchive project | DELETE /api/projects/:id | YES (rank 5 >= 5) | IMPLEMENTED |
| UC-PROJECTMANAGER-009 | View project dashboard tab | GET /api/projects/:id/dashboard | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-010 | View project reports | GET /api/projects/:id/reports | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-011 | View project calendar | GET /api/projects/:id/calendar | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-012 | Read workflow config | GET /api/projects/:id/workflow | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-013 | Update custom workflow | PUT /api/projects/:id/workflow | YES (rank 5 >= 5) | IMPLEMENTED |
| UC-PROJECTMANAGER-014 | Read activity journal | GET /api/projects/:id/activity | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-015 | List project members (+license flags) | GET /api/projects/:id/members | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-016 | Search addable users | GET /api/projects/:id/members/available | YES (rank 5 >= 5) | IMPLEMENTED |
| UC-PROJECTMANAGER-017 | Add member (auto-license; 409 if no seat) | POST /api/projects/:id/members | YES (rank 5 >= 5) | IMPLEMENTED |
| UC-PROJECTMANAGER-018 | Change member role | PATCH /api/projects/:id/members/:userId | YES (rank 5 >= 5) | IMPLEMENTED |
| UC-PROJECTMANAGER-019 | Remove member | DELETE /api/projects/:id/members/:userId | YES (rank 5 >= 5) | IMPLEMENTED |
| UC-PROJECTMANAGER-020 | List / board / get / backlog tasks | GET /api/projects/:id/tasks* | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-021 | Create task (+ optional assignee) | POST /api/projects/:id/tasks | YES (rank 5 >= 3) | IMPLEMENTED |
| UC-PROJECTMANAGER-022 | Full task update (PUT) | PUT /api/projects/:id/tasks/:taskId | YES (rank 5 >= 2) | IMPLEMENTED |
| UC-PROJECTMANAGER-023 | Change task status (transition/move) | PATCH /api/projects/:id/tasks/:taskId/{status,move} | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-024 | Edit task checklist | PATCH /api/projects/:id/tasks/:taskId/checklist | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-025 | Watch / unwatch task | POST /api/projects/:id/tasks/:taskId/watch | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-026 | Delete task | DELETE /api/projects/:id/tasks/:taskId | YES (rank 5 >= 3) | IMPLEMENTED |
| UC-PROJECTMANAGER-027 | List milestones | GET /api/projects/:id/milestones | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-028 | List sprints | GET /api/projects/:id/sprints | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-029 | Create / start / complete / plan / delete sprint | POST/PATCH/PUT/DELETE /api/projects/:id/sprints* | YES (rank 5 >= 3) | IMPLEMENTED |
| UC-PROJECTMANAGER-030 | Read comments | GET /api/projects/:id/comments | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-031 | Post comment (+ @mentions) | POST /api/projects/:id/comments | YES (rank 5 >= 1) | IMPLEMENTED |
| UC-PROJECTMANAGER-032 | Edit / delete comment | PUT/DELETE /api/projects/:id/comments/:commentId | YES (rank 5 >= 5) | IMPLEMENTED |
| UC-PROJECTMANAGER-033 | List files | GET /api/projects/:id/files | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-034 | Upload file | POST /api/projects/:id/files | YES (rank 5 >= 1) | IMPLEMENTED |
| UC-PROJECTMANAGER-035 | Delete file | DELETE /api/projects/:id/files/:fileId | YES (rank 5 >= 3) | IMPLEMENTED |
| UC-PROJECTMANAGER-036 | List time entries | GET /api/projects/:id/time | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-037 | Log time | POST /api/projects/:id/time | YES (rank 5 >= 2) | IMPLEMENTED |
| UC-PROJECTMANAGER-038 | Edit / delete time entry | PATCH/DELETE /api/projects/:id/time/:entryId | YES (rank 5 >= 3) | IMPLEMENTED |
| UC-PROJECTMANAGER-039 | List deliverables | GET /api/projects/:id/deliverables | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-040 | Submit deliverable | POST /api/projects/:id/deliverables | YES (rank 5 >= 2) | IMPLEMENTED |
| UC-PROJECTMANAGER-041 | Approve / reject deliverable | PATCH /api/projects/:id/deliverables/:id/status | YES (rank 5 >= 4 (approveWork)) | IMPLEMENTED |
| UC-PROJECTMANAGER-042 | Delete deliverable | DELETE /api/projects/:id/deliverables/:id | YES (rank 5 >= 3) | IMPLEMENTED |
| UC-PROJECTMANAGER-043 | List meetings/events | GET /api/projects/:id/events | YES (permission + guard only) | IMPLEMENTED |
| UC-PROJECTMANAGER-044 | Create / update / delete event | POST/PUT/DELETE /api/projects/:id/events* | YES (rank 5 >= 3) | IMPLEMENTED |
...
## UC-PROJECTMANAGER-001 — List projects
...
- Project membership with effective rank 5 (or tenant-visible read-only for rank-free reads)
...
## UC-PROJECTMANAGER-002 — View global dashboard
...
## UC-PROJECTMANAGER-003 — View personal dashboard (my tasks)
...
## UC-PROJECTMANAGER-004 — Cross-project search
...
## UC-PROJECTMANAGER-005 — Create project
...
## UC-PROJECTMANAGER-006 — View project detail
...
## UC-PROJECTMANAGER-007 — Update project settings
...
## UC-PROJECTMANAGER-008 — Archive / unarchive project
...
4. `requireProductAccess('project_management', perm)` verifies subscription + license + product permission (403 PRODUCT_NOT_ACCESSIBLE / LICENSE_NOT_ASSIGNED / PERMISSION_DENIED)
5. `guardProjectRole(resolveProjectRole(...))` verifies project membership or tenant visibility (403 PROJECT_FORBIDDEN)
6. Controller rank rule: rank>=5 — this role: rank 5 >= 5
...
### Permissions
- route perm project.project.archive + rank rule 5 — evaluated: rank 5 >= 5
...
## UC-PROJECTMANAGER-009 — View project dashboard tab
...
## UC-PROJECTMANAGER-010 — View project reports
...
## UC-PROJECTMANAGER-011 — View project calendar
...
## UC-PROJECTMANAGER-012 — Read workflow config
...
## UC-PROJECTMANAGER-013 — Update custom workflow
...
### Permissions
- route perm project.workflow.manage + rank rule 5 — evaluated: rank 5 >= 5
...
## UC-PROJECTMANAGER-014 — Read activity journal
...
## UC-PROJECTMANAGER-015 — List project members (+license flags)
...
## UC-PROJECTMANAGER-016 — Search addable users
...
### Permissions
- route perm project.member.manage + rank rule 5 — evaluated: rank 5 >= 5
...
## UC-PROJECTMANAGER-017 — Add member (auto-license; 409 if no seat)
...
## UC-PROJECTMANAGER-018 — Change member role
...
## UC-PROJECTMANAGER-019 — Remove member
...
## UC-PROJECTMANAGER-020 — List / board / get / backlog tasks
...
## UC-PROJECTMANAGER-021 — Create task (+ optional assignee)
...
4. `requireProductAccess('project_management', perm)` verifies subscription + license + product permission (403 PRODUCT_NOT_ACCESSIBLE / LICENSE_NOT_ASSIGNED / PERMISSION_DENIED)
5. `guardProjectRole(resolveProjectRole(...))` verifies project membership or tenant visibility (403 PROJECT_FORBIDDEN)
6. Controller rank rule: rank>=3 — this role: rank 5 >= 3
7. Controller executes; writes activity/audit/notify as listed below
8. Response 200/201 (or domain 4xx: LICENSE_REQUIRED, INVALID_ASSIGNEE, WIP_LIMIT…)
...
### Permissions
- route perm project.task.create + rank rule 3 — evaluated: rank 5 >= 3
...
## UC-PROJECTMANAGER-022 — Full task update (PUT)
...
4. `requireProductAccess('project_management', perm)` verifies subscription + license + product permission (403 PRODUCT_NOT_ACCESSIBLE / LICENSE_NOT_ASSIGNED / PERMISSION_DENIED)
5. `guardProjectRole(resolveProjectRole(...))` verifies project membership or tenant visibility (403 PROJECT_FORBIDDEN)
6. Controller rank rule: assignee-or-2 — this role: rank 5 >= 2
7. Controller executes; writes activity/audit/notify as listed below
8. Response 200/201 (or domain 4xx: LICENSE_REQUIRED, INVALID_ASSIGNEE, WIP_LIMIT…)
...
### Permissions
- route perm project.task.update + rank rule assignee-or-2 — evaluated: rank 5 >= 2
...
## UC-PROJECTMANAGER-023 — Change task status (transition/move)
...
## UC-PROJECTMANAGER-024 — Edit task checklist
...
## UC-PROJECTMANAGER-025 — Watch / unwatch task
...
## UC-PROJECTMANAGER-026 — Delete task
...
### Permissions
- route perm project.task.delete + rank rule 3 — evaluated: rank 5 >= 3
...
## UC-PROJECTMANAGER-027 — List milestones
...
## UC-PROJECTMANAGER-028 — List sprints
...
## UC-PROJECTMANAGER-029 — Create / start / complete / plan / delete sprint
...
### Permissions
- route perm project.sprint.manage + rank rule 3 — evaluated: rank 5 >= 3
...
## UC-PROJECTMANAGER-030 — Read comments
...
## UC-PROJECTMANAGER-031 — Post comment (+ @mentions)
...
4. `requireProductAccess('project_management', perm)` verifies subscription + license + product permission (403 PRODUCT_NOT_ACCESSIBLE / LICENSE_NOT_ASSIGNED / PERMISSION_DENIED)
5. `guardProjectRole(resolveProjectRole(...))` verifies project membership or tenant visibility (403 PROJECT_FORBIDDEN)
6. Controller rank rule: rank>=1 — this role: rank 5 >= 1
7. Controller executes; writes activity/audit/notify as listed below
8. Response 200/201 (or domain 4xx: LICENSE_REQUIRED, INVALID_ASSIGNEE, WIP_LIMIT…)
...
### Permissions
- route perm project.project.read + rank rule 1 — evaluated: rank 5 >= 1
...
## UC-PROJECTMANAGER-032 — Edit / delete comment
...
4. `requireProductAccess('project_management', perm)` verifies subscription + license + product permission (403 PRODUCT_NOT_ACCESSIBLE / LICENSE_NOT_ASSIGNED / PERMISSION_DENIED)
5. `guardProjectRole(resolveProjectRole(...))` verifies project membership or tenant visibility (403 PROJECT_FORBIDDEN)
6. Controller rank rule: author-or-5 — this role: rank 5 >= 5
7. Controller executes; writes activity/audit/notify as listed below
8. Response 200/201 (or domain 4xx: LICENSE_REQUIRED, INVALID_ASSIGNEE, WIP_LIMIT…)
...
### Permissions
- route perm project.project.read + rank rule author-or-5 — evaluated: rank 5 >= 5
...
## UC-PROJECTMANAGER-033 — List files
...
## UC-PROJECTMANAGER-034 — Upload file
...
## UC-PROJECTMANAGER-035 — Delete file
...
### Permissions
- route perm project.project.read + rank rule 3 — evaluated: rank 5 >= 3
...
## UC-PROJECTMANAGER-036 — List time entries
...
## UC-PROJECTMANAGER-037 — Log time
...
4. `requireProductAccess('project_management', perm)` verifies subscription + license + product permission (403 PRODUCT_NOT_ACCESSIBLE / LICENSE_NOT_ASSIGNED / PERMISSION_DENIED)
5. `guardProjectRole(resolveProjectRole(...))` verifies project membership or tenant visibility (403 PROJECT_FORBIDDEN)
6. Controller rank rule: rank>=2 — this role: rank 5 >= 2
7. Controller executes; writes activity/audit/notify as listed below
8. Response 200/201 (or domain 4xx: LICENSE_REQUIRED, INVALID_ASSIGNEE, WIP_LIMIT…)
...
### Permissions
- route perm project.time.log + rank rule 2 — evaluated: rank 5 >= 2
...
## UC-PROJECTMANAGER-038 — Edit / delete time entry
...
4. `requireProductAccess('project_management', perm)` verifies subscription + license + product permission (403 PRODUCT_NOT_ACCESSIBLE / LICENSE_NOT_ASSIGNED / PERMISSION_DENIED)
5. `guardProjectRole(resolveProjectRole(...))` verifies project membership or tenant visibility (403 PROJECT_FORBIDDEN)
6. Controller rank rule: own-or-3 — this role: rank 5 >= 3
7. Controller executes; writes activity/audit/notify as listed below
8. Response 200/201 (or domain 4xx: LICENSE_REQUIRED, INVALID_ASSIGNEE, WIP_LIMIT…)
...
### Permissions
- route perm project.time.log + rank rule own-or-3 — evaluated: rank 5 >= 3
...
## UC-PROJECTMANAGER-039 — List deliverables
...
## UC-PROJECTMANAGER-040 — Submit deliverable
...
### Permissions
- route perm project.task.update + rank rule 2 — evaluated: rank 5 >= 2
...
## UC-PROJECTMANAGER-041 — Approve / reject deliverable
...
4. `requireProductAccess('project_management', perm)` verifies subscription + license + product permission (403 PRODUCT_NOT_ACCESSIBLE / LICENSE_NOT_ASSIGNED / PERMISSION_DENIED)
5. `guardProjectRole(resolveProjectRole(...))` verifies project membership or tenant visibility (403 PROJECT_FORBIDDEN)
6. Controller rank rule: 4-or-owner — this role: rank 5 >= 4 (approveWork)
7. Controller executes; writes activity/audit/notify as listed below
8. Response 200/201 (or domain 4xx: LICENSE_REQUIRED, INVALID_ASSIGNEE, WIP_LIMIT…)
...
### Permissions
- route perm project.task.update + rank rule 4-or-owner — evaluated: rank 5 >= 4 (approveWork)
...
## UC-PROJECTMANAGER-042 — Delete deliverable
...
## UC-PROJECTMANAGER-043 — List meetings/events
...
## UC-PROJECTMANAGER-044 — Create / update / delete event
...
### Permissions
- route perm project.event.manage + rank rule 3 — evaluated: rank 5 >= 3
