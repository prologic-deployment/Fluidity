# Role: procurement_viewer

| UC | Action | API | Status |
|---|---|---|---|
| UC-PROCUREMENTVIEWER-001 | See procurement in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-PROCUREMENTVIEWER-002 | Order procurement | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-PROCUREMENTVIEWER-003 | Open the procurement module | /apps/procurement | NOT_IMPLEMENTED |
| UC-PROCUREMENTVIEWER-004 | Assign procurement_viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-PROCUREMENTVIEWER-005 | Use a procurement license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-PROCUREMENTVIEWER-001 — See procurement in the catalog
...
- Product procurement (coming_soon)
...
## UC-PROCUREMENTVIEWER-002 — Order procurement
...
## UC-PROCUREMENTVIEWER-003 — Open the procurement module
...
## UC-PROCUREMENTVIEWER-004 — Assign procurement_viewer to a user
...
## UC-PROCUREMENTVIEWER-005 — Use a procurement license
