...
|---|---|---|---|
| UC-ASSETUSER-001 | See asset_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-ASSETUSER-002 | Order asset_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-ASSETUSER-003 | Open the asset_management module | /apps/asset_management | NOT_IMPLEMENTED |
| UC-ASSETUSER-004 | Assign asset_user to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-ASSETUSER-005 | Use a asset_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-ASSETUSER-001 — See asset_management in the catalog
...
## UC-ASSETUSER-002 — Order asset_management
...
## UC-ASSETUSER-003 — Open the asset_management module
...
## UC-ASSETUSER-004 — Assign asset_user to a user
...
## UC-ASSETUSER-005 — Use a asset_management license
