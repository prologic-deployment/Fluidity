...
|---|---|---|---|
| UC-BIADMIN-001 | See business_intelligence in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-BIADMIN-002 | Order business_intelligence | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-BIADMIN-003 | Open the business_intelligence module | /apps/business_intelligence | NOT_IMPLEMENTED |
| UC-BIADMIN-004 | Assign bi_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-BIADMIN-005 | Use a business_intelligence license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-BIADMIN-001 — See business_intelligence in the catalog
...
## UC-BIADMIN-002 — Order business_intelligence
...
## UC-BIADMIN-003 — Open the business_intelligence module
...
## UC-BIADMIN-004 — Assign bi_admin to a user
...
## UC-BIADMIN-005 — Use a business_intelligence license
