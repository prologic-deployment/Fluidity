...
|---|---|---|---|
| UC-MONITORINGVIEWER-001 | See monitoring in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-MONITORINGVIEWER-002 | Order monitoring | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-MONITORINGVIEWER-003 | Open the monitoring module | /apps/monitoring | NOT_IMPLEMENTED |
| UC-MONITORINGVIEWER-004 | Assign viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-MONITORINGVIEWER-005 | Use a monitoring license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-MONITORINGVIEWER-001 — See monitoring in the catalog
...
## UC-MONITORINGVIEWER-002 — Order monitoring
...
## UC-MONITORINGVIEWER-003 — Open the monitoring module
...
## UC-MONITORINGVIEWER-004 — Assign viewer to a user
...
## UC-MONITORINGVIEWER-005 — Use a monitoring license
