...
|---|---|---|---|
| UC-TIMEMANAGER-001 | See time_tracking in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-TIMEMANAGER-002 | Order time_tracking | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-TIMEMANAGER-003 | Open the time_tracking module | /apps/time_tracking | NOT_IMPLEMENTED |
| UC-TIMEMANAGER-004 | Assign time_manager to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-TIMEMANAGER-005 | Use a time_tracking license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-TIMEMANAGER-001 — See time_tracking in the catalog
...
## UC-TIMEMANAGER-002 — Order time_tracking
...
## UC-TIMEMANAGER-003 — Open the time_tracking module
...
## UC-TIMEMANAGER-004 — Assign time_manager to a user
...
## UC-TIMEMANAGER-005 — Use a time_tracking license
