...
|---|---|---|---|
| UC-TIMEADMIN-001 | See time_tracking in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-TIMEADMIN-002 | Order time_tracking | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-TIMEADMIN-003 | Open the time_tracking module | /apps/time_tracking | NOT_IMPLEMENTED |
| UC-TIMEADMIN-004 | Assign time_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-TIMEADMIN-005 | Use a time_tracking license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-TIMEADMIN-001 — See time_tracking in the catalog
...
## UC-TIMEADMIN-002 — Order time_tracking
...
## UC-TIMEADMIN-003 — Open the time_tracking module
...
## UC-TIMEADMIN-004 — Assign time_admin to a user
...
## UC-TIMEADMIN-005 — Use a time_tracking license
