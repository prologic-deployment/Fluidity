...
|---|---|---|---|
| UC-DOCUMENTMANAGER-001 | See document_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-DOCUMENTMANAGER-002 | Order document_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-DOCUMENTMANAGER-003 | Open the document_management module | /apps/document_management | NOT_IMPLEMENTED |
| UC-DOCUMENTMANAGER-004 | Assign document_manager to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-DOCUMENTMANAGER-005 | Use a document_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-DOCUMENTMANAGER-001 — See document_management in the catalog
...
## UC-DOCUMENTMANAGER-002 — Order document_management
...
## UC-DOCUMENTMANAGER-003 — Open the document_management module
...
## UC-DOCUMENTMANAGER-004 — Assign document_manager to a user
...
## UC-DOCUMENTMANAGER-005 — Use a document_management license
