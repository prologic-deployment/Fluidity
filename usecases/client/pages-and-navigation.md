...
| Sidebar | — | Workspace (tickets/demandes/changements) ONLY — no Projects (unless entitled, impossible), no Contrats/Clients (hidden; /contrats legal via URL — GAP-11), no Subscriptions/Users/platform |
