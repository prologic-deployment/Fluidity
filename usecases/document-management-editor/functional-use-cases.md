...
|---|---|---|---|
| UC-DOCUMENTMANAGEMENTEDITOR-001 | See document_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-DOCUMENTMANAGEMENTEDITOR-002 | Order document_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-DOCUMENTMANAGEMENTEDITOR-003 | Open the document_management module | /apps/document_management | NOT_IMPLEMENTED |
| UC-DOCUMENTMANAGEMENTEDITOR-004 | Assign editor to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-DOCUMENTMANAGEMENTEDITOR-005 | Use a document_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-DOCUMENTMANAGEMENTEDITOR-001 — See document_management in the catalog
...
## UC-DOCUMENTMANAGEMENTEDITOR-002 — Order document_management
...
## UC-DOCUMENTMANAGEMENTEDITOR-003 — Open the document_management module
...
## UC-DOCUMENTMANAGEMENTEDITOR-004 — Assign editor to a user
...
## UC-DOCUMENTMANAGEMENTEDITOR-005 — Use a document_management license
