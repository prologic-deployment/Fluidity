# Role: service_manager (servicedesk)
...
- Assign service_manager to a user — IMPLEMENTED
- Remove service_manager from a user — IMPLEMENTED
- Exercise service_manager permissions — NOT_IMPLEMENTED
- Access ServiceDesk holding service_manager — PARTIAL
