...
|---|---|---|---|
| UC-CONTRACTUSER-001 | See contract_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-CONTRACTUSER-002 | Order contract_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-CONTRACTUSER-003 | Open the contract_management module | /apps/contract_management | NOT_IMPLEMENTED |
| UC-CONTRACTUSER-004 | Assign contract_user to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-CONTRACTUSER-005 | Use a contract_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-CONTRACTUSER-001 — See contract_management in the catalog
...
## UC-CONTRACTUSER-002 — Order contract_management
...
## UC-CONTRACTUSER-003 — Open the contract_management module
...
## UC-CONTRACTUSER-004 — Assign contract_user to a user
...
## UC-CONTRACTUSER-005 — Use a contract_management license
