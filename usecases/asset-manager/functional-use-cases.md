...
|---|---|---|---|
| UC-ASSETMANAGER-001 | See asset_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-ASSETMANAGER-002 | Order asset_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-ASSETMANAGER-003 | Open the asset_management module | /apps/asset_management | NOT_IMPLEMENTED |
| UC-ASSETMANAGER-004 | Assign asset_manager to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-ASSETMANAGER-005 | Use a asset_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-ASSETMANAGER-001 — See asset_management in the catalog
...
## UC-ASSETMANAGER-002 — Order asset_management
...
## UC-ASSETMANAGER-003 — Open the asset_management module
...
## UC-ASSETMANAGER-004 — Assign asset_manager to a user
...
## UC-ASSETMANAGER-005 — Use a asset_management license
