...
|---|---|---|---|
| UC-KNOWLEDGECENTEREDITOR-001 | See knowledge_center in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-KNOWLEDGECENTEREDITOR-002 | Order knowledge_center | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-KNOWLEDGECENTEREDITOR-003 | Open the knowledge_center module | /apps/knowledge_center | NOT_IMPLEMENTED |
| UC-KNOWLEDGECENTEREDITOR-004 | Assign editor to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-KNOWLEDGECENTEREDITOR-005 | Use a knowledge_center license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-KNOWLEDGECENTEREDITOR-001 — See knowledge_center in the catalog
...
- Product knowledge_center (coming_soon)
...
## UC-KNOWLEDGECENTEREDITOR-002 — Order knowledge_center
...
## UC-KNOWLEDGECENTEREDITOR-003 — Open the knowledge_center module
...
## UC-KNOWLEDGECENTEREDITOR-004 — Assign editor to a user
...
## UC-KNOWLEDGECENTEREDITOR-005 — Use a knowledge_center license
