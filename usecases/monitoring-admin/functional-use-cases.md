...
|---|---|---|---|
| UC-MONITORINGADMIN-001 | See monitoring in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-MONITORINGADMIN-002 | Order monitoring | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-MONITORINGADMIN-003 | Open the monitoring module | /apps/monitoring | NOT_IMPLEMENTED |
| UC-MONITORINGADMIN-004 | Assign monitoring_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-MONITORINGADMIN-005 | Use a monitoring license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-MONITORINGADMIN-001 — See monitoring in the catalog
...
## UC-MONITORINGADMIN-002 — Order monitoring
...
## UC-MONITORINGADMIN-003 — Open the monitoring module
...
## UC-MONITORINGADMIN-004 — Assign monitoring_admin to a user
...
## UC-MONITORINGADMIN-005 — Use a monitoring license
