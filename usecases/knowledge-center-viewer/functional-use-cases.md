...
|---|---|---|---|
| UC-KNOWLEDGECENTERVIEWER-001 | See knowledge_center in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-KNOWLEDGECENTERVIEWER-002 | Order knowledge_center | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-KNOWLEDGECENTERVIEWER-003 | Open the knowledge_center module | /apps/knowledge_center | NOT_IMPLEMENTED |
| UC-KNOWLEDGECENTERVIEWER-004 | Assign viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-KNOWLEDGECENTERVIEWER-005 | Use a knowledge_center license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-KNOWLEDGECENTERVIEWER-001 — See knowledge_center in the catalog
...
## UC-KNOWLEDGECENTERVIEWER-002 — Order knowledge_center
...
## UC-KNOWLEDGECENTERVIEWER-003 — Open the knowledge_center module
...
## UC-KNOWLEDGECENTERVIEWER-004 — Assign viewer to a user
...
## UC-KNOWLEDGECENTERVIEWER-005 — Use a knowledge_center license
