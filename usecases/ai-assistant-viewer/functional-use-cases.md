...
|---|---|---|---|
| UC-AIASSISTANTVIEWER-001 | See ai_assistant in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-AIASSISTANTVIEWER-002 | Order ai_assistant | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-AIASSISTANTVIEWER-003 | Open the ai_assistant module | /apps/ai_assistant | NOT_IMPLEMENTED |
| UC-AIASSISTANTVIEWER-004 | Assign viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-AIASSISTANTVIEWER-005 | Use a ai_assistant license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-AIASSISTANTVIEWER-001 — See ai_assistant in the catalog
...
- Product ai_assistant (coming_soon)
...
## UC-AIASSISTANTVIEWER-002 — Order ai_assistant
...
## UC-AIASSISTANTVIEWER-003 — Open the ai_assistant module
...
## UC-AIASSISTANTVIEWER-004 — Assign viewer to a user
...
## UC-AIASSISTANTVIEWER-005 — Use a ai_assistant license
