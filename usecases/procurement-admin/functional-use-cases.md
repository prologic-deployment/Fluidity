...
|---|---|---|---|
| UC-PROCUREMENTADMIN-001 | See procurement in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-PROCUREMENTADMIN-002 | Order procurement | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-PROCUREMENTADMIN-003 | Open the procurement module | /apps/procurement | NOT_IMPLEMENTED |
| UC-PROCUREMENTADMIN-004 | Assign procurement_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-PROCUREMENTADMIN-005 | Use a procurement license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-PROCUREMENTADMIN-001 — See procurement in the catalog
...
## UC-PROCUREMENTADMIN-002 — Order procurement
...
## UC-PROCUREMENTADMIN-003 — Open the procurement module
...
## UC-PROCUREMENTADMIN-004 — Assign procurement_admin to a user
...
## UC-PROCUREMENTADMIN-005 — Use a procurement license
