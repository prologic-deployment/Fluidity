...
|---|---|---|---|
| UC-HRADMIN-001 | See hr_center in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-HRADMIN-002 | Order hr_center | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-HRADMIN-003 | Open the hr_center module | /apps/hr_center | NOT_IMPLEMENTED |
| UC-HRADMIN-004 | Assign hr_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-HRADMIN-005 | Use a hr_center license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-HRADMIN-001 — See hr_center in the catalog
...
## UC-HRADMIN-002 — Order hr_center
...
## UC-HRADMIN-003 — Open the hr_center module
...
## UC-HRADMIN-004 — Assign hr_admin to a user
...
## UC-HRADMIN-005 — Use a hr_center license
