...
|---|---|---|---|
| UC-ASSETADMIN-001 | See asset_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-ASSETADMIN-002 | Order asset_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-ASSETADMIN-003 | Open the asset_management module | /apps/asset_management | NOT_IMPLEMENTED |
| UC-ASSETADMIN-004 | Assign asset_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-ASSETADMIN-005 | Use a asset_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-ASSETADMIN-001 — See asset_management in the catalog
...
## UC-ASSETADMIN-002 — Order asset_management
...
## UC-ASSETADMIN-003 — Open the asset_management module
...
## UC-ASSETADMIN-004 — Assign asset_admin to a user
...
## UC-ASSETADMIN-005 — Use a asset_management license
