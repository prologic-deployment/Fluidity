...
|---|---|---|---|
| UC-AIASSISTANTUSER-001 | See ai_assistant in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-AIASSISTANTUSER-002 | Order ai_assistant | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-AIASSISTANTUSER-003 | Open the ai_assistant module | /apps/ai_assistant | NOT_IMPLEMENTED |
| UC-AIASSISTANTUSER-004 | Assign user to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-AIASSISTANTUSER-005 | Use a ai_assistant license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-AIASSISTANTUSER-001 — See ai_assistant in the catalog
...
## UC-AIASSISTANTUSER-002 — Order ai_assistant
...
## UC-AIASSISTANTUSER-003 — Open the ai_assistant module
...
## UC-AIASSISTANTUSER-004 — Assign user to a user
...
## UC-AIASSISTANTUSER-005 — Use a ai_assistant license
