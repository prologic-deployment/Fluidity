...
|---|---|---|---|
| UC-AIMANAGER-001 | See ai_assistant in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-AIMANAGER-002 | Order ai_assistant | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-AIMANAGER-003 | Open the ai_assistant module | /apps/ai_assistant | NOT_IMPLEMENTED |
| UC-AIMANAGER-004 | Assign ai_manager to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-AIMANAGER-005 | Use a ai_assistant license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-AIMANAGER-001 — See ai_assistant in the catalog
...
## UC-AIMANAGER-002 — Order ai_assistant
...
## UC-AIMANAGER-003 — Open the ai_assistant module
...
## UC-AIMANAGER-004 — Assign ai_manager to a user
...
## UC-AIMANAGER-005 — Use a ai_assistant license
