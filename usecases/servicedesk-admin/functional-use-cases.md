# Role: servicedesk_admin

| UC | Action | API | Status |
|---|---|---|---|
| UC-SERVICEDESKADMIN-001 | Assign servicedesk_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-SERVICEDESKADMIN-002 | Remove servicedesk_admin from a user | DELETE /api/platform/roles/assignments/:id | IMPLEMENTED |
| UC-SERVICEDESKADMIN-003 | Exercise servicedesk_admin permissions | (any servicedesk API) | NOT_IMPLEMENTED |
| UC-SERVICEDESKADMIN-004 | Access ServiceDesk holding servicedesk_admin | GET /api/tickets etc. | PARTIAL |

## UC-SERVICEDESKADMIN-001 — Assign servicedesk_admin to a user
...
- RoleAssignment(servicedesk_admin) present (except for the assignment UC itself)
...
## UC-SERVICEDESKADMIN-002 — Remove servicedesk_admin from a user
...
## UC-SERVICEDESKADMIN-003 — Exercise servicedesk_admin permissions
...
## UC-SERVICEDESKADMIN-004 — Access ServiceDesk holding servicedesk_admin
