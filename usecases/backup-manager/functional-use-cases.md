...
|---|---|---|---|
| UC-BACKUPMANAGER-001 | See backup_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-BACKUPMANAGER-002 | Order backup_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-BACKUPMANAGER-003 | Open the backup_management module | /apps/backup_management | NOT_IMPLEMENTED |
| UC-BACKUPMANAGER-004 | Assign backup_manager to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-BACKUPMANAGER-005 | Use a backup_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-BACKUPMANAGER-001 — See backup_management in the catalog
...
## UC-BACKUPMANAGER-002 — Order backup_management
...
## UC-BACKUPMANAGER-003 — Open the backup_management module
...
## UC-BACKUPMANAGER-004 — Assign backup_manager to a user
...
## UC-BACKUPMANAGER-005 — Use a backup_management license
