...
|---|---|---|---|
| UC-BUYER-001 | See procurement in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-BUYER-002 | Order procurement | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-BUYER-003 | Open the procurement module | /apps/procurement | NOT_IMPLEMENTED |
| UC-BUYER-004 | Assign buyer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-BUYER-005 | Use a procurement license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-BUYER-001 — See procurement in the catalog
...
## UC-BUYER-002 — Order procurement
...
## UC-BUYER-003 — Open the procurement module
...
## UC-BUYER-004 — Assign buyer to a user
...
## UC-BUYER-005 — Use a procurement license
