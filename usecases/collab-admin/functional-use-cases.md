...
|---|---|---|---|
| UC-COLLABADMIN-001 | See collaboration in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-COLLABADMIN-002 | Order collaboration | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-COLLABADMIN-003 | Open the collaboration module | /apps/collaboration | NOT_IMPLEMENTED |
| UC-COLLABADMIN-004 | Assign collab_admin to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-COLLABADMIN-005 | Use a collaboration license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-COLLABADMIN-001 — See collaboration in the catalog
...
## UC-COLLABADMIN-002 — Order collaboration
...
## UC-COLLABADMIN-003 — Open the collaboration module
...
## UC-COLLABADMIN-004 — Assign collab_admin to a user
...
## UC-COLLABADMIN-005 — Use a collaboration license
