...
|---|---|---|---|
| UC-FLEETVIEWER-001 | See fleet_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-FLEETVIEWER-002 | Order fleet_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-FLEETVIEWER-003 | Open the fleet_management module | /apps/fleet_management | NOT_IMPLEMENTED |
| UC-FLEETVIEWER-004 | Assign fleet_viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-FLEETVIEWER-005 | Use a fleet_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-FLEETVIEWER-001 — See fleet_management in the catalog
...
## UC-FLEETVIEWER-002 — Order fleet_management
...
## UC-FLEETVIEWER-003 — Open the fleet_management module
...
## UC-FLEETVIEWER-004 — Assign fleet_viewer to a user
...
## UC-FLEETVIEWER-005 — Use a fleet_management license
