...
|---|---|---|---|
| UC-ASSETMANAGEMENTVIEWER-001 | See asset_management in the catalog | GET /api/platform/products (public) | IMPLEMENTED |
| UC-ASSETMANAGEMENTVIEWER-002 | Order asset_management | POST /api/platform/me/orders | NOT_IMPLEMENTED |
| UC-ASSETMANAGEMENTVIEWER-003 | Open the asset_management module | /apps/asset_management | NOT_IMPLEMENTED |
| UC-ASSETMANAGEMENTVIEWER-004 | Assign viewer to a user | POST /api/platform/roles/assignments | IMPLEMENTED |
| UC-ASSETMANAGEMENTVIEWER-005 | Use a asset_management license | POST /api/platform/licenses | NOT_IMPLEMENTED |

## UC-ASSETMANAGEMENTVIEWER-001 — See asset_management in the catalog
...
- Product asset_management (coming_soon)
...
## UC-ASSETMANAGEMENTVIEWER-002 — Order asset_management
...
## UC-ASSETMANAGEMENTVIEWER-003 — Open the asset_management module
...
## UC-ASSETMANAGEMENTVIEWER-004 — Assign viewer to a user
...
## UC-ASSETMANAGEMENTVIEWER-005 — Use a asset_management license
