# Pages & navigation: PLATFORM_ADMIN
...
| Sidebar (own) | — | platform groups only: dashboard, tenants, users, SaaS (products/orders/subs/licenses/matrix), notifications, audit, roles, settings |
| Sidebar (impersonating) | — | tenant workspace of the impersonated tenant |
