...
| UC-PA-010 | Review / approve / reject orders (atomic, seat-expansion validation, deterministic duplicate-live refusal) | GET\|PATCH\|POST /api/platform/orders* | IMPLEMENTED |
