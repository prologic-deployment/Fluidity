...
function rolePermissions(roleKey, productKey) {
  ...
  const map = {
    ...
    project_lead: ['project.project.read', 'project.task.create', 'project.task.read', 'project.task.update', 'project.task.assign', 'project.task.complete', 'project.task.comment', 'project.time.manage', 'project.report.read', 'project.activity.read'],
