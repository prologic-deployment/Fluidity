...
const PERMISSIONS_BY_PRODUCT = {
  ...
  project_management: [
    ...
    'project.task.complete', 'project.task.delete',
...
function rolePermissions(roleKey, productKey) {
  ...
  const map = {
    ...
    project_manager: ['project.project.create', 'project.project.read', 'project.project.update', 'project.project.archive', 'project.member.manage', 'project.task.create', 'project.task.update', 'project.task.assign', 'project.task.complete', 'project.task.delete', 'project.milestone.create', 'project.milestone.update', 'project.milestone.delete', 'project.sprint.manage', 'project.risk.manage', 'project.issue.manage', 'project.time.log', 'project.event.manage', 'project.report.read', 'project.workflow.manage', 'project.change.manage', 'project.test.manage'],
    ...
    project_lead: ['project.project.read', 'project.task.create', 'project.task.update', 'project.task.assign', 'project.task.complete', 'project.time.log', 'project.report.read', 'project.change.manage', 'project.test.manage'],
    ...
    qa: ['project.project.read', 'project.task.update', 'project.task.complete', 'project.issue.manage', 'project.time.log', 'project.test.manage'],
    stakeholder: ['project.project.read', 'project.report.read'],
    project_member: ['project.project.read', 'project.task.update', 'project.time.log'],
    project_viewer: ['project.project.read', 'project.report.read'],
    // Fleet
