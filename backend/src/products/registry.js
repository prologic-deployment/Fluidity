...
function rolePermissions(roleKey, productKey) {
  ...
  const map = {
    ...
    scrum_master: ['project.project.read', 'project.task.read', 'project.task.update', 'project.task.comment', 'project.sprint.manage', 'project.backlog.manage', 'project.event.manage', 'project.issue.manage', 'project.activity.read', 'project.report.read'],
    project_lead: ['project.project.read', 'project.task.create', 'project.task.read', 'project.task.update', 'project.task.assign', 'project.task.complete', 'project.task.comment', 'project.time.log', 'project.report.read', 'project.activity.read'],
